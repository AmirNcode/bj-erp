...
function DialogContent({
  ...
  /**
   * Accessible name for the close button. The app is Farsi-first, so any
   * consumer must pass a translated string — the English default exists only
   * so the primitive stays usable on its own.
   */
  closeLabel?: string
}) {
  return (
