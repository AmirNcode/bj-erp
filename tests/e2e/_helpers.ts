 ...
 * app_cleanup_e2e_users() reserves for throwaway accounts. The resulting
 * login codes look like prod-9991234567.
 */
 ...
 * departments and is deleted after the run by scripts/cleanup-e2e.mjs. Login
 * codes generated inside them (zz1a2b-9991234567) still match the pattern
 * app_cleanup_e2e_users() deletes, so the accounts self-clean too.
 */
 ...
 * the app (department code + personnel number) and read from the preview.
 * Returns the generated code and the temp password.
 */
